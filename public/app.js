  ...
  .then(function(data) {
    ...
    // For each one
      ...
      // Display the apropos information on the page 
                ...
                $("#articles").append("<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#modalCenter'>Article Notes</button>");
  ...
  $("#note-article").on("click", function() {
    ...
    $.ajax({
      ...
      .then(function(data) {
        ...
        // $("#notes").append("<div class='modal' tabindex='-1' role='dialog'>");
        // $("#notes").append("<div class='modal-dialog' role='document'>");
        // $("#notes").append("<div class='modal-content'>");
        // $("#notes").append("<div class='modal-header'>");
        // $("#notes").append("<h5 class='modal-title'>" + data.title + "</h5>");
        // $("#notes").append("<button type='button' class='close' data-dismiss='modal' aria-label='Close'>");
        // $("#notes").append("<span aria-hidden='true'>&times;</span></button></div>");
